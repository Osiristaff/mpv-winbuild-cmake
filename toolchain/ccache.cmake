ExternalProject_Add(ccache
    ...
    CONFIGURE_COMMAND ${EXEC_HOST} ${CMAKE_COMMAND} -H<SOURCE_DIR> -B<BINARY_DIR>
        ...
        "-DCMAKE_CXX_FLAGS='-DBLAKE3_NO_SSE2 -DBLAKE3_NO_SSE41 -DXXH_ENABLE_AUTOVECTORIZE -include stdlib.h ${tc_cflags} ${tc_libcxx} ${tc_compiler_rt} ${llvm_pgo} -U_LIBCPP_REMOVE_TRANSITIVE_INCLUDES'"
